...
Claude Code is used **only for repo maintenance** — reformatting problem files to a consistent structure and keeping the README up to date. All solutions, thought processes, and explanations are written by the repo owner. Claude does not write or suggest any code or reasoning.

## What This Repo Is

A personal collection of NeetCode 150 solutions, written in Java and documented in Markdown. Each problem file captures the full thought process, not just the final answer. The repo is public-facing and recruiter-oriented.
...
- Each problem file follows this structure:
  1. `# Problem Name — NeetCode 150 #N` heading
  2. Problem statement
  3. `## Examples` section
...
1. **Badge numbers** — manually increment the `Solved` count and the appropriate difficulty badge (`Easy`, `Medium`, or `Hard`)
